...
const createPricingRule = (0, catchAsync_1.default)(async (req, res) => {
...
const getPricingRules = (0, catchAsync_1.default)(async (req, res) => {
...
const getPricingRule = (0, catchAsync_1.default)(async (req, res) => {
...
const updatePricingRule = (0, catchAsync_1.default)(async (req, res) => {
...
const deletePricingRule = (0, catchAsync_1.default)(async (req, res) => {
