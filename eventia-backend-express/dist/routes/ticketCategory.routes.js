 ...
 */
router.post('/ticket-categories', (0, auth_1.auth)('admin'), ticketCategory_controller_1.TicketCategoryController.createTicketCategory);
/**
 * @swagger
 ...
 */
router.get('/events/:eventId/ticket-categories', ticketCategory_controller_1.TicketCategoryController.getTicketCategoriesByEventId);
/**
 * @swagger
 ...
 */
router.get('/ticket-categories/:id', ticketCategory_controller_1.TicketCategoryController.getTicketCategoryById);
/**
 * @swagger
 * /api/ticket-categories/{id}:
 *   patch:
 ...
 *         description: Ticket category not found
 */
router.patch('/ticket-categories/:id', (0, auth_1.auth)('admin'), ticketCategory_controller_1.TicketCategoryController.updateTicketCategory);
/**
 * @swagger
 * /api/ticket-categories/{id}:
 *   delete:
 ...
 *         description: Ticket category not found
 */
router.delete('/ticket-categories/:id', (0, auth_1.auth)('admin'), ticketCategory_controller_1.TicketCategoryController.deleteTicketCategory);
/**
 * @swagger
