...
const ARVenuePreview = () => {
  ...
  const toggleAR = () => {
    ...
    toast({
      title: t('ar.modeTitle') || 'AR Mode',
      description: t('ar.modeDescription') || 'Point your camera at a flat surface to place the stadium model.',
    });
  };
      ...
      <main className="flex-grow pt-16 pb-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="mb-6 flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">{t('ar.stadiumPreviewTitle') || 'Stadium AR Preview'}</h1>
              <p className="text-sm text-gray-600">{t('ar.stadiumPreviewSubtitle') || 'Experience the venue before booking your tickets'}</p>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <Button onClick={toggleAR} className="w-full mt-4">
                        ...
                        {t('ar.launch') || 'View in AR on Your Device'}
                      </Button>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-bold mb-2">{t('ar.readyToBook') || 'Ready to Book Tickets?'}</h3>
                    <p className="text-gray-600 text-sm">
                      {t('ar.previewCta') || `Now that you've previewed the venue, secure your seats before they sell out!`}
                    </p>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="text-sm text-gray-600 mb-1">{t('ar.selectedSection') || 'Selected Section'}</div>
