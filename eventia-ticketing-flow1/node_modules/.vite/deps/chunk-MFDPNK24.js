  ...
  const handleEntries = ({ entries }) => {
    ...
    entries.forEach((entry) => {
      if (isPerformanceEventTiming2(entry)) {
        ...
        if (existingInteraction) {
          existingInteraction.duration = Math.max(existingInteraction.duration, duration);
        } else if (keys.length < MAX_INTERACTIONS2 || minInteractionId === void 0 || duration > interactionIdToRouteNameMapping[minInteractionId].duration) {
...
//# sourceMappingURL=chunk-MFDPNK24.js.map
