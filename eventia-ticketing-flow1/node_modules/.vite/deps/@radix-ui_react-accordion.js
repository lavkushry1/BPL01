...
var useInsertionEffect2 = React10[" useInsertionEffect ".trim().toString()] || useLayoutEffect22;
...
var Collapsible = React16.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCollapsible,
      open: openProp,
...
var CollapsibleTrigger = React16.forwardRef(
  (props, forwardedRef) => {
...
var CollapsibleContent = React16.forwardRef(
  (props, forwardedRef) => {
...
var CollapsibleContentImpl = React16.forwardRef((props, forwardedRef) => {
  const { __scopeCollapsible, present, children, ...contentProps } = props;
  const context = useCollapsibleContext(CONTENT_NAME, __scopeCollapsible);
  const [isPresent, setIsPresent] = React16.useState(present);
  const ref = React16.useRef(null);
  const composedRefs = useComposedRefs2(forwardedRef, ref);
  const heightRef = React16.useRef(0);
  const height = heightRef.current;
  const widthRef = React16.useRef(0);
  const width = widthRef.current;
  const isOpen = context.open || isPresent;
  const isMountAnimationPreventedRef = React16.useRef(isOpen);
  const originalStylesRef = React16.useRef(void 0);
  React16.useEffect(() => {
...
var useReactId2 = React17[" useId ".trim().toString()] || (() => void 0);
var count2 = 0;
function useId2(deterministicId) {
  const [id, setId] = React17.useState(useReactId2());
  useLayoutEffect2(() => {
